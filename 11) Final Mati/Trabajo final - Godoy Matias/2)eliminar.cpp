...
void eliminar(), eliminar_alumnnos(), eliminar_profesores(), eliminar_aulas(), eliminar_libros(), escape();
int main(){
	int menu;
    do{
    	system("cls");
    	SetConsoleTextAttribute(hConsole, 12);
        cout<<endl<<endl<<"\tBAJA DE RECURSOS"<<endl<<endl;
        SetConsoleTextAttribute(hConsole, 7);
        cout<<"\t1. Dar de baja alumnos"<<endl;
        cout<<"\t2. Dar de baja profesores"<<endl;
        cout<<"\t3. Dar de baja libros"<<endl;
        cout<<"\t4. Dar de baja aulas "<<endl<<endl;
...
void eliminar_alumnnos(){
    ...
    system("cls");
	SetConsoleTextAttribute(hConsole, 12);
    cout<<endl<<endl<<"\tBAJA DE ALUMNO "<<endl<<endl;
    SetConsoleTextAttribute(hConsole, 7);
	cout<<"\tIngrese el DNI del alumno que deseas dar de baja: ";
	cin>>codigoP;
	system("cls");
	FILE *m;
	FILE *n;
    ...
    if (m== NULL || n== NULL){
        ...
        system("cls");
        SetConsoleTextAttribute(hConsole, 12);
        cout<<endl<<endl<<"\tNo hay alumnos dados de alta "<<endl<<endl;
        SetConsoleTextAttribute(hConsole, 7);
        escape();
        return;
    }
    	...
    	while(feof(m)==0){
    		if(codigoP==alum.dni){
    			SetConsoleTextAttribute(hConsole, 12);
    			cout<<endl<<endl<<"\tLos datos del alumno a dar de baja son: "<<endl<<endl;
    			SetConsoleTextAttribute(hConsole, 7);
    ...
    if(continuar==1){
		...
		system("cls");
		SetConsoleTextAttribute(hConsole, 12);
		cout<<endl<<endl<<"\tDATOS DADOS DE BAJA CORRECTAMENTE."<<endl<<endl;
		SetConsoleTextAttribute(hConsole, 7);
		escape();
	}
    if(seguridad==0){
...
void eliminar_profesores(){
    ...
    system("cls");
	SetConsoleTextAttribute(hConsole, 12);
    cout<<endl<<endl<<"\tBAJA DE PROFESOR"<<endl<<endl;
    SetConsoleTextAttribute(hConsole, 7);
	cout<<"\tIngrese el DNI del profesor que deseas dar de baja: ";
	cin>>codigoP;
	system("cls");
	FILE *m;
	FILE *n;
    ...
    if (m== NULL || n== NULL){
        ...
        system("cls");
        SetConsoleTextAttribute(hConsole, 12);
        cout<<endl<<endl<<"\tNo hay profesores dados de alta "<<endl<<endl;
        SetConsoleTextAttribute(hConsole, 7);
        escape();
        return;
    }
    	...
    	while(feof(m)==0){
    		if(codigoP==prof.dni){
    			SetConsoleTextAttribute(hConsole, 12);
    			cout<<endl<<endl<<"\tLos datos del profesor a dar de baja son: "<<endl<<endl;
    			SetConsoleTextAttribute(hConsole, 7);
    ...
    if(continuar==1){
		...
		system("cls");
		SetConsoleTextAttribute(hConsole, 12);
		cout<<endl<<endl<<"\tDATOS DADO DE BAJA CORRECTAMENTE."<<endl<<endl;
		SetConsoleTextAttribute(hConsole, 7);
		escape();
	}
    if(seguridad==0){
...
void eliminar_libros(){
    ...
    system("cls");
	SetConsoleTextAttribute(hConsole, 12);
    cout<<endl<<endl<<"\tBAJA DE LIBRO"<<endl<<endl;
    SetConsoleTextAttribute(hConsole, 7);
	cout<<"\tIngrese el codigo del libro que deseas dar de baja: ";
	cin>>codigoP;
	system("cls");
	FILE *m;
	FILE *n;
    ...
    if (m== NULL || n== NULL){
    	...
    	while(feof(m)==0){
    		if(codigoP==biblio.codigo){
    			SetConsoleTextAttribute(hConsole, 12);
    			cout<<endl<<endl<<"\tLos datos del libro a dar de baja son: "<<endl<<endl;
    			SetConsoleTextAttribute(hConsole, 7);
...
void eliminar_aulas(){
    ...
    system("cls");
	SetConsoleTextAttribute(hConsole, 12);
    cout<<endl<<endl<<"\tBAJA DE AULAS"<<endl<<endl;
    SetConsoleTextAttribute(hConsole, 7);
	cout<<"\tIngrese el NUMERO del aula que deseas dar de baja: ";
	cin>>codigoP;
	system("cls");
	FILE *m;
	FILE *n;
    ...
    if (m== NULL || n== NULL){
        ...
        system("cls");
        SetConsoleTextAttribute(hConsole, 12);
        cout<<endl<<endl<<"\tNo hay aulas dados de alta "<<endl<<endl;
        SetConsoleTextAttribute(hConsole, 7);
        escape();
        return;
    }
    	...
    	while(feof(m)==0){
    		if(codigoP==aul.numero){
    			SetConsoleTextAttribute(hConsole, 12);
    			cout<<endl<<endl<<"\tLos datos del aula a dar de baja son: "<<endl<<endl;
    			SetConsoleTextAttribute(hConsole, 7);
	            cout<<"\tNumero: "<<aul.numero<<endl;
	            cout<<"\tAudiovisual: "<<aul.proyector<<endl;
    ...
    if(continuar==1){
		...
		system("cls");
		SetConsoleTextAttribute(hConsole, 12);
		cout<<endl<<endl<<"\tDATOS DE BAJA CORRECTAMENTE."<<endl<<endl;
		SetConsoleTextAttribute(hConsole, 7);
		escape();
	}
    if(seguridad==0){
