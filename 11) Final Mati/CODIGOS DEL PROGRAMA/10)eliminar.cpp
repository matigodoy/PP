...
void eliminar(), eliminar_alumnnos(), eliminar_profesores(), eliminar_pers_admin(), eliminar_aulas(), eliminar_libros(), escape();
int main(){
	int menu;
    do{
    	system("cls");
        ...
        cout<<"\t3. Elimninar personal administrativo"<<endl;
        cout<<"\t4. Elimninar libros"<<endl;
        cout<<"\t5. Elimninar aulas "<<endl<<endl;
...
void eliminar_pers_admin(){
	int seguridad=0, continuar=0;
	long int codigoP=0;
    system("cls");
	SetConsoleTextAttribute(hConsole, 12);
    cout<<endl<<endl<<"\tELIMINAR PERSONAL ADMINISTRATIVO"<<endl<<endl;
    SetConsoleTextAttribute(hConsole, 7);
	cout<<"\tIngrese el DNI del personal administrativo que deseas eliminar: ";
	cin>>codigoP;
	system("cls");
	FILE *m;
	FILE *n;
    ...
    if (m== NULL || n== NULL){
    	...
    	while(feof(m)==0){
    		if(codigoP==admin.dni){
    			SetConsoleTextAttribute(hConsole, 12);
    			cout<<endl<<endl<<"\tLos datos del personal administrativo a eliminar son: "<<endl<<endl;
    			SetConsoleTextAttribute(hConsole, 7);
    ...
    if(seguridad==0){
		system("cls");
		SetConsoleTextAttribute(hConsole, 12);
		cout<<endl<<endl<<"\tEl DNI ingresado no corresponde a ningun personal administrativo ."<<endl<<endl;
		SetConsoleTextAttribute(hConsole, 7);
		escape();
	}
}
